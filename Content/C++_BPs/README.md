...
* **Skald_MainHUDBP** – Blueprint subclass of `USkaldMainHUDWidget` used for the in-game HUD. Implements `BP_RebuildPlayerList(Players: Array<FS_PlayerData>)` to rebuild the on-screen player list. See `Skald_MainHUDBP.json` for a description of the expected setup.
