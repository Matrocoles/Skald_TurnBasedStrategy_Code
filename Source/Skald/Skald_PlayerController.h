...
protected:
  ...
  /** Niagara or Cascade cue to spawn for successful hits. */
  UPROPERTY(EditDefaultsOnly, BlueprintReadWrite, Category = "Battle|Feedback")
  UFXSystemAsset *HitImpactEffect = nullptr;

  /** Niagara or Cascade cue to spawn for misses. */
  UPROPERTY(EditDefaultsOnly, BlueprintReadWrite, Category = "Battle|Feedback")
  UFXSystemAsset *MissImpactEffect = nullptr;
