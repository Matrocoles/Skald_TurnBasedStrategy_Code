                                         ...
                                         bool bShouldBeVisible)
{
  ...
  // UE 5.5 removed UWorld::SetShouldBeVisible so newer builds fall back to
  // toggling the persistent level's visibility flag directly and forcing a
  // streaming update instead.
#if UE_VERSION_OLDER_THAN(5, 5, 0)
  if (World) {
...
#else
  PersistentLevel->bIsVisible = bShouldBeVisible;
  if (World) {
